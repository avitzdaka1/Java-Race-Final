...
/**
 * This class used for making javafx table view cells editable taken from
 * http://www.naturalborncoder.com/java/javafx/2012/04/26/complete-javafx-2-editable-table-example/
 * @author Graham Smith
 */

public class TavleViewEditCell extends TableCell<String, String> {
	private TextField textField;

	public TavleViewEditCell() { }
